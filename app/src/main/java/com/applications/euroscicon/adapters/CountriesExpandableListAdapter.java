...
import com.applications.euroscicon.utils.ConstantManager;

import java.util.ArrayList;
import java.util.HashMap;


public class CountriesExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public CountriesExpandableListAdapter(Activity activity, ArrayList<HashMap<String, String>> parentItems,
    ...
    public View getGroupView(final int groupPosition, final boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            if(isFromMyCategoriesFragment) {
                convertView = inflater.inflate(R.layout.group_list_layout_my_countries, null);
            }else {
                convertView = inflater.inflate(R.layout.group_list_layout_choose_countries, null);
            }
    ...
    public View getChildView(final int groupPosition, final int childPosition, final boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.child_list_layout_choose_country, null);
