...
public class YRFAdapter extends RecyclerView.Adapter<YRFAdapter.SingleViewHolder> {
    ...
    public YRFAdapter(Context context, ArrayList<Categories> categories, CatClickListener myListener) {
        ...
        void bind(final Categories categories) {
           ...
           /* Log.d(TAG, "bind: "+check);
            if (!check){
             ...
             imageView.setImageResource(categories.isChecked() ? R.drawable.ic_check_circle : R.drawable.ic_uncheck_circle);
           ...
           /* if (categories.isChecked()) {
            ...
            itemView.setOnClickListener(view -> {
                ...
                if (checkedPosition != getAdapterPosition()) {
                   ...
                   // myListener.listener(checkedPosition,1);
                    ...
                    if (txtPrice1.isEnabled()) {
                        ...
                        myListener.yrflistener(checkedPosition,  categories.getPrice1());
                        ...
                        myListener.yrflistener(checkedPosition,  categories.getPrice2());
                        ...
                        //Toast.makeText(mContext, "" + check, Toast.LENGTH_SHORT).show();
                        myListener.yrflistener(checkedPosition,  categories.getPrice3());
                    }
                    ...
                    imageView.setImageResource(R.drawable.ic_uncheck_circle);
                    checkedPosition = -1;
                    myListener.yrflistener(checkedPosition,"");
                    if (txtPrice1.isEnabled()) {
