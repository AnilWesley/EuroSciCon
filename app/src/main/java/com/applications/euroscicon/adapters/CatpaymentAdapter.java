package com.applications.euroscicon.adapters;
...
import com.applications.euroscicon.listener.CatClickListener;
...
public class CatpaymentAdapter extends RecyclerView.Adapter<CatpaymentAdapter.SingleViewHolder> {
    ...
    public CatpaymentAdapter(Context context, ArrayList<Categories> categories, CatClickListener myListener) {
...
/*
             ...
             imageView.setImageResource(categories.isChecked() ?
...
*/
            ...
            if (categories.isChecked()) {
                ...
                if (txtPrice1.isEnabled()) {
                    ...
                    myListener.catlistener(true,checkedPosition,  categories.getPrice1());
                    ...
                    myListener.catlistener(true,checkedPosition,  categories.getPrice2());
                    ...
                    myListener.catlistener(true,checkedPosition,  categories.getPrice3());
                    Log.d(TAG, "bind: " + "price33");
                }

            } else {
                imageView.setImageResource(R.drawable.ic_uncheck_circle);
                myListener.catlistener(false,-1,"0.00");
                if (txtPrice1.isEnabled()) {
            ...
            itemView.setOnClickListener(view -> {
                ...
                if (checkedPosition != getAdapterPosition()) {
                    ...
                    if (txtPrice1.isEnabled()) {
                        ...
                        txtPrice1.setTextColor(Color.parseColor("#4CAF50"));
                        txtPrice1.setBackgroundResource(R.drawable.rounded_ouline);
                        Log.d(TAG, "bind: " + categories.getPrice1());
                        ...
                        txtPrice2.setTextColor(Color.parseColor("#4CAF50"));
                        txtPrice2.setBackgroundResource(R.drawable.rounded_ouline);
                        Log.d(TAG, "bind: " + categories.getPrice2());
                        myListener.catlistener(true,checkedPosition,  categories.getPrice2());
                        ...
                        txtPrice3.setTextColor(Color.parseColor("#4CAF50"));
                        txtPrice3.setBackgroundResource(R.drawable.rounded_ouline);
                        Log.d(TAG, "bind: " + categories.getPrice3());
                        myListener.catlistener(true,checkedPosition,  categories.getPrice3());
                    }
                    ...
                    imageView.setImageResource(R.drawable.ic_uncheck_circle);
                    checkedPosition = -1;
                    myListener.catlistener(false,checkedPosition, "0.00");
