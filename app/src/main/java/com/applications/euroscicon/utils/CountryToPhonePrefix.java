package com.applications.euroscicon.utils;
...
public class CountryToPhonePrefix {
    ...
    public CountryToPhonePrefix() {
    }

    public   List<CountryToPhonePrefix> getAll() {
        if (allList == null) {
            ArrayList<CountryToPhonePrefix> list = new ArrayList<>();
            list.add(new CountryToPhonePrefix("Select Your Country", "00"));
